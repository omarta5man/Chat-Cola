...
const flavors = [
  {
    ...
    name: "Chat Cola",
    tagline: "Original",
    description: "The original refreshing cola taste with a bold Palestinian identity.",
    image: "/images/chat-cola-classic-can.jpg",
    bgColor: "from-red-600/20 via-red-600/10 to-transparent",
    accentColor: "#DC2626",
    tags: ["Original", "Refreshing", "Classic", "150ml & 250ml"],
  },
  {
    id: 2,
    name: "Zero Cola",
    tagline: "Zero Sugar",
    description: "The cola taste you love with a lighter zero-style option.",
    image: "/images/zero-cola-can.jpg",
    bgColor: "from-gray-600/20 via-gray-600/10 to-transparent",
    accentColor: "#4B5563",
    tags: ["Zero", "Cola", "Refreshing", "150ml & 250ml"],
  },
  {
    id: 3,
    name: "Blue Chat",
    tagline: "Bold Flavor",
    description: "A bold blue soda flavour made to stand out.",
    image: "/images/blue-chat-can.jpg",
    bgColor: "from-blue-600/20 via-blue-600/10 to-transparent",
    accentColor: "#2563EB",
    tags: ["Blue", "Bold", "Fizzy", "250ml"],
  },
]
                  ...
                  <div className="grid md:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="space-y-4">
                      ...
                      {!currentFlavor.mystery && (
                        ...
                        >
                          <motion.button
                            className="px-6 py-3 rounded-full font-bold text-sm tracking-wide relative overflow-hidden text-white"
                          ...
                          <motion.button
                            className="px-6 py-3 rounded-full font-bold text-sm tracking-wide border-2"
                            style={{ borderColor: currentFlavor.accentColor, color: currentFlavor.accentColor }}
                            whileHover={{ scale: 1.02, backgroundColor: currentFlavor.accentColor, color: "#fff" }}
                            whileTap={{ scale: 0.98 }}
                            transition={{ type: "spring", stiffness: 400, damping: 17 }}
                          >
                            Ask for Supply
